            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <figure class="form-box-img">
                  <?php if(isset($services['files'][0])):?>
                    <button type="button" class="btn btn-danger btn-fill remove" data-uid="<?=$services['files'][0]['id'];?>">Remover</button>
                    <?php echo $this->Html->image('../uploads/files/'.$services['files'][0]['filename'], ['class'=>'form-img', 'data-uid'=>$services['files'][0]['id']]);?>
                  <?php else:?>
