  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="content">
          <?= $this->Form->create($convenios, ['type'=>'file']) ?>
            ...
            <div class="col-md-3">
              <div class="form-group">
                ...
                <figure class="form-box-img">
                  <?php if(isset($convenios['files'][0])):?>
                    <button type="button" class="btn btn-danger btn-fill remove" data-uid="<?=$convenios['files'][0]['id'];?>">Remover</button>
                    <?php echo $this->Html->image('../uploads/files/'.$convenios['files'][0]['filename'], ['class'=>'form-img', 'data-uid'=>$convenios['files'][0]['id']]);?>
                  <?php else:?>
                  ...
                  <?php echo $this->Form->hidden('files.0.entity', ['class'=>'form-file', 'value'=>'Convenios']);?>
