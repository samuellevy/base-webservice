            ...
            <tbody>
              <?php foreach ($specialties as $specialty): ?>
                <tr>
                  ...
                  <td class="actions">
                    <?php //= $this->Html->link(__('Ver'), ['action' => 'view', $specialty->id]) ?>
                    <?= $this->Html->link(__('Editar'), ['action' => 'edit', $specialty->id]) ?>
                    <?= $this->Form->postLink(__('Remover'), ['action' => 'delete', $specialty->id], ['confirm' => __('Are you sure you want to delete # {0}?', $specialty->id)]) ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
