          ...
          <table class="table table-hover table-striped">
            <thead>
              <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('page', ['label'=>'Página']) ?></th>
            ...
            <tbody>
              <?php foreach ($services_tabs as $tab): ?>
                <tr>
                  ...
                  <td class="actions">
                    <?php //= $this->Html->link(__('Ver'), ['action' => 'view', $tab->id]) ?>
                    <?= $this->Html->link(__('Editar'), ['action' => 'edit', $tab->id]) ?>
                    <?= $this->Form->postLink(__('Remover'), ['action' => 'delete', $tab->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tab->id)]) ?>
                  </td>
                </tr>
              <?php endforeach; ?>
            </tbody>
